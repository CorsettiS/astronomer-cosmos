...
class RenderConfig:
    ...
    :param enable_owner_inheritance: A boolean that allows users to control whether to inherit owner from dbt nodes. Defaults to True to maintain backward compatibility.
    """
