...
class RenderConfig:
    ...
    :param disable_node_owner: A boolean that allows users to disable setting the Airflow task owner from the dbt node owner. Defaults to False (backwards compatible).
    """
